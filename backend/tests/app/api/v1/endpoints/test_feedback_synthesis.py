...
def test_feed_back_inserts_feedback_document():
    ...
    req = module.Request(user_email='u@test.com', query='q', model='gpt', results=[], stars_graph=5, feed_graph='ok', stars_synthe=4, feed_synthe='bien', synthesis='texto')
...
def test_update_synthe_content_and_stats():
    ...
    result_2 = module.update_synthe_stats(module.UpdateStatsSyntheRequest(feedback_id='f1', stars_synthe=4, feed_synthe='bien'))
