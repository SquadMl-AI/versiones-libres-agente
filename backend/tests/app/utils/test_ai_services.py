...
def prepare_module():
    ...
    sys.modules["azure.ai.formrecognizer"].DocumentAnalysisClient = type(
        "DocumentAnalysisClient", (), {"__init__": lambda self, *a, **k: None}
    )
    ...
    class BlobServiceClient:
        ...
        def from_connection_string(conn):
            return type(
                ...
                (),
                {
                    "get_container_client": lambda self, name: type(
                        "Container",
                        (),
                        {
                            "list_blobs": lambda self, name_starts_with="": [
                                type("B", (), {"name": "a/file1.pdf"})(),
                                type("B", (), {"name": "a/file2.txt"})(),
                            ]
                        },
                    )()
                },
