...
def setup_mock_service():
    ...
    mock_search.hybrid_search.return_value = [
        {
            "doc_id": "1",
            "content": "Cont Alto Score",
            "bloque": "b1",
            "docnm": "d1",
            "@search.score": 10.0,
            "@search.reranker_score": 3.0,
            "@search.highlights": {"content": ["<em>alto</em> score"]},
        },
        {
            "doc_id": "2",
            "content": "Cont Bajo Score",
            "bloque": "b1",
            "docnm": "d2",
            "@search.score": 5.0,
    ...
    return (
        load_module_from_source("services/search_category_service.py", "src_search_cat_service"),
        mock_search,
        mock_aoai,
    )
