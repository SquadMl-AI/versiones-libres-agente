...
def chat_ask_sentencias(request:RequestSentencias):
    ...
    response= search_sentencias.rag_pipeline(user_query=request.query, user_email=request.user_email, index_name=request.index)
...
def chat_ask_audiencias(request:RequestAudiencias):
    ...
    response= search_audiencias.rag_pipeline(user_query=request.query, user_email=request.user_email, index_name=request.index)
