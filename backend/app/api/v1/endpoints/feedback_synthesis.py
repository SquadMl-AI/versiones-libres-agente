...
def update_graph_feedback(update: UpdateGraphRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error al actualizar el feedback de grafo")
...
# Modificar las estrellas y feedback de síntesis
...
def update_stats_synthe_feedback(update: UpdateStatsSyntheRequest):
    filter_query = {"_id": update.feedback_id}
    update_fields = {
