...
# =================================================================================================
#                                                           PIPELINE DEL SERVICIO RAG PARA AUDIENCIAS
# =================================================================================================
...
class RAGPipelineAudiencias:
    ...
    def generate_cited_answer(
        ...
        # Regex que maneja plurales, sinónimos y es insensible a mayúsculas/minúsculas
        ...
        # Normalizar los resultados para asegurar consistencia
        ...
        # Construir la lista de fuentes final basada en las que el modelo citó
    ...
    def rag_pipeline(
        ...
        print(
            ...
            "DESDE LA BASE DE CONOCIMIENTOS DE AUDIENCIAS #############################\n"
        )
        ...
        # Paso 3: Obtener historial de conversaciones
        ...
        for m in history:
            if m.get("type") == "ai":
                ...
                # Si es string, intenta deserializar
                if isinstance(content, str):
                    try:
                        ...
                        try:
                            ...
                            content = {}
                # Ahora sí puedes acceder a 'answer'
...
if __name__ == "__main__":
    ...
    # pregunta_usuario = "¿Qué se determinó sobre la participación de la 
    # guerrilla del M-19 en los eventos de la masacre de El Salado?"

    # Iniciar el pipeline
    ragpipeline = RAGPipelineAudiencias()
    final_response = ragpipeline.rag_pipeline(
        pregunta_usuario, index_name="index_audiencias", top_k=5, user_email="Default"
    )